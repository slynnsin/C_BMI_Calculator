...
{
	if (BMI <= 18.5)
		printf("\nYour BMI of %lf indicates you are underweight.", BMI);
	else if (BMI <= 25)
		printf("\nYour BMI of %lf indicates you are a normal weight.", BMI);
	else if (BMI <= 30)
		printf("\nYour BMI of %lf indicates you are overweight.", BMI);
	else
		printf("\nYour BMI of %lf indicates you are obese.", BMI);
	return 0;
}